...
// 🔥 بنك ألغاز تخمين الكلمة العملاق والمعقد (أكثر من 100 لغز بدون تكرار)
...
io.on('connection', (socket) => {
    ...
    socket.on('joinRoom', (data) => {
        try {
            ...
            if (rooms[roomId]) {
                ...
                // 🔥 الرسالة الذكية لو الغرفة اتقفلت أو مش موجودة
    ...
    function startNextRebusRound(roomId) {
        ...
        // 🔥 التايمر اتبرمج هنا على 80 ثانية
        io.to(roomId).emit('rebusRoundStarted', { round: rooms[roomId].currentRound, clue: puz.clue, category: puz.category, duration: 80 });
